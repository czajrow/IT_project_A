...
//                        .setAction("Action", null).show();
    ...
    private void goToMapActivity() {
        MapsPins.setPinsToMyEvents(AllEventsContainer.getEvents());
    ...
    public static class SimpleItemRecyclerViewAdapter
            ...
            implements AllEventsContainer.AllEventsDataChanged {


        private final EventItemListActivity mParentActivity;
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(EventItemDetailFragment.ARG_ITEM_ID, item.getTitle());
                    ...
                    intent.putExtra(EventItemDetailFragment.ARG_ITEM_ID, item.getTitle());
        ...
        SimpleItemRecyclerViewAdapter(EventItemListActivity parent,
                                      List<Event> items,
                                      boolean twoPane) {
            mValues = items;
            ...
            AllEventsContainer.setDataChangeCallback(this);
        }

        @Override
        public void allEventsDataChanged(List<Event> newList) {
